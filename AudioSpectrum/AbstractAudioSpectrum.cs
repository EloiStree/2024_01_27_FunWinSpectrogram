...
public abstract class AbstractAudioSpectrum : MonoBehaviour
{
    ...
    public abstract void GetSpectrumRawData(ref float[] raw);

    void Update ()
    {
        CheckBuffers ();

         GetSpectrumRawData(ref rawSpectrum);
